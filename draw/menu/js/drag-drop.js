...
function JSDragDropTree()
{
    ...
    this.folderImage = 'wenjian.png';
    this.plusImage = 'arr.svg';
    this.minusImage = 'folder-open.svg';
    this.maximumDepth = 6;
...
JSDragDropTree.prototype = {
    ...
    */
    ...
    showHideNode : function(e,inputId)
    {
        ...
        if(thisNode.className.indexOf("fa-caret-right")>0){
           // thisNode.src = thisNode.src.replace(JSTreeObj.plusImage,JSTreeObj.minusImage);
           // console.log("fa-caret-down 1");
            thisNode.className="fa fa-caret-down";
           ...
           // console.log("fa-caret-down 2");
            thisNode.className="fa fa-caret-right";
    ...
    createDropIndicator : function()
    {
        ...
        img.src = this.imageFolder + 'dragDrop_ind2.gif';
        img.width=15;
        img.heith=6;
    ...
    initTree : function()
    {
        ...
        for(var no=0;no<menuItems.length;no++){
           ...
           //  var img = document.createElement('IMG');
            ...
            img.className ="fa fa-caret-right";
