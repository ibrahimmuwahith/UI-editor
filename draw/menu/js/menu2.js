...
function JSDragDropTree()
{
    ...
    this.imageFolder = '';
    this.folderImage = 'fa fa-clone';
    this.plusImage = 'fa fa-angle-right';
    this.minusImage = 'fa fa-angle-down';
    this.maximumDepth = 6;
...
JSDragDropTree.prototype = {
    ...
    */
    ...
    showHideNode : function(e,inputId)
    {
        ...
        if(thisNode&&thisNode.style&&thisNode.style.visibility=='hidden')return;
    ...
    moveDragableNodes : function(e)
    {
        ...
        JSTreeObj.floatingContainer.style.left = dragDrop_x+40 + 'px';
        JSTreeObj.floatingContainer.style.top = dragDrop_y + 'px';

        var thisObj = this;
        if(thisObj.tagName=='A' || thisObj.tagName=='i')thisObj = thisObj.parentNode;
        ...
        if(thisObj && thisObj.id)
        {
            ...
            var img = thisObj.getElementsByTagName('i')[1];
            var tmpObj= JSTreeObj.dropTargetIndicator;
            tmpObj.style.display='block';

            var eventSourceObj = this;
            if(JSTreeObj.dragNode_noSiblings && eventSourceObj.tagName=='i')eventSourceObj = eventSourceObj.nextSibling;

            var tmpImg = tmpObj.getElementsByTagName('i')[0];
            if(this.tagName=='A' || JSTreeObj.dragNode_noSiblings){
                tmpImg.className = tmpImg.className.replace('ind1','ind2');
              //  tmpImg.src = tmpImg.src.replace('ind1','ind2');
                JSTreeObj.insertAsSub = true;
                tmpObj.style.left = (JSTreeObj.getLeftPos(eventSourceObj) + JSTreeObj.indicator_offsetX_sub) + 'px';
            }else{
                tmpImg.className = tmpImg.className.replace('ind2','ind1');
    ...
    dropDragableNodes:function()
    {
        ...
        if(JSTreeObj.dragNode_destination){
            if(JSTreeObj.insertAsSub){
                ...
                var img = JSTreeObj.dragNode_destination.getElementsByTagName('i')[0];
            ...
            if(lis.length==0){
                var img = tmpObj.parentNode.getElementsByTagName('i')[0];
    ...
    __refreshDisplay : function(obj)
    {
        ...
        var img = obj.getElementsByTagName('i')[0];
    ...
    initTree : function()
    {
        ...
        for(var no=0;no<menuItems.length;no++){
           ...
           // img.src = this.imageFolder + this.plusImage;
            img.className ="fa fa-angle-right";
            ...
            var folderImg = document.createElement('i');
            ...
            if(menuItems[no].className){
               // folderImg.src = this.imageFolder + menuItems[no].className;
                folderImg.className = "fa "+ menuItems[no].className;
            }else{
               // folderImg.src = this.imageFolder + this.folderImage;
                folderImg.className ="fa fa-clone";
            }
